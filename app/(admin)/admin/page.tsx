            ...
            <section className="min-h-screen bg-gray-50 flex gap-8 p-6 md:p-8 font-semibold" dir="rtl">         
                ...
                <div className="flex-1 bg-white shadow-sm shadow-gray-200/60 rounded-3xl p-8 border border-gray-100">
                    <div className="mb-8 pb-4 border-b border-gray-50 flex justify-between items-center">
                        ...
                        <span className="text-xs font-medium text-gray-400 bg-gray-50 px-3 py-1.5 rounded-md">خوش آمدید میثاق عزیز</span>
                    </div>
                    ...
                    <div className="max-w-4xl mx-auto space-y-8">
                            ...
                            {[
                                ...
                                <div key={i} className="border border-gray-100 bg-gray-50/40 rounded-2xl p-5 flex items-center justify-between">
                                    <div className="space-y-1.5">
                                        <span className="text-xs text-gray-400 block font-bold">{stat.label}</span>
                        ...
                        <div className="border border-gray-100 rounded-2xl p-6 bg-gray-50/20">
                            <h3 className="text-sm font-black text-gray-900 mb-4">دسترسی سریع عملیاتی</h3>
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                <Link href="/admin/products/create" className="flex items-center justify-center gap-2 border border-dashed border-gray-200 hover:border-[#D92F4E] bg-white hover:text-[#D92F4E] p-4 rounded-xl text-xs font-bold transition-all text-gray-600 group">
                                    <svg className="w-4 h-4 text-gray-400 group-hover:text-[#D92F4E]"><use href="#plus-circle"></use></svg>
                                    افزودن محصول جدید
                                </Link>
                                <Link href="/admin/products/category" className="flex items-center justify-center gap-2 border border-dashed border-gray-200 hover:border-[#D92F4E] bg-white hover:text-[#D92F4E] p-4 rounded-xl text-xs font-bold transition-all text-gray-600 group">
                                    <svg className="w-4 h-4 text-gray-400 group-hover:text-[#D92F4E]"><use href="#tag"></use></svg>
                                    ساخت دسته‌بندی جدید
                                </Link>
                                <Link href="/admin/products/manage-products" className="flex items-center justify-center gap-2 border border-dashed border-gray-200 hover:border-[#D92F4E] bg-white hover:text-[#D92F4E] p-4 rounded-xl text-xs font-bold transition-all text-gray-600 group">
                        ...
                        <div className="border border-gray-100 rounded-2xl overflow-hidden bg-white">
                            <div className="p-4 bg-gray-50/50 border-b border-gray-100 flex justify-between items-center">
                                <h3 className="text-sm font-black text-gray-900">آخرین قطعات اضافه شده به البرز سی‌ان‌سی</h3>
                                <Link href="/admin/products/manage-products" className="text-xs font-bold text-[#D92F4E] hover:underline">مشاهده همه</Link>
                            </div>
                            <div className="divide-y divide-gray-50">
                                {[
                                    ...
                                    <div key={index} className="p-4 flex items-center justify-between hover:bg-gray-50/30 transition-all text-xs">
